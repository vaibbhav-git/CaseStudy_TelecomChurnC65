# Telecom Churn Case Study for upGrad
...
4. Train model, tune model hyperparameters, etc. (handle class imbalance using appropriate techniques).
5. Evaluate the model using appropriate evaluation metrics. 
